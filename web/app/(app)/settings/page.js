...
function PerUserTab({ templates }) {
  ...
  function selectUser(u) {
    ...
    setIsDirty(false);
    const base = u.permissions ?? templates[u.role] ?? {};
  ...
  function handleReset() {
    const base = templates[selectedUser.role] ?? {};
    setDraftPerms(JSON.parse(JSON.stringify(base)));
  ...
  const isCustom = selectedUser?.permissions !== null && selectedUser?.permissions !== undefined;
