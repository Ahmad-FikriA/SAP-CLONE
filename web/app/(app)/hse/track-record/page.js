      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm ml-11">
            Leaderboard pelapor teraktif & petugas HSE berdasarkan data laporan
            K3.
          </p>
        </div>
        <button
            ...
            extra: o.count > 0 ? (
              <span className="flex items-center gap-2">
                <span className="flex items-center gap-1">
                  <Wrench size={10} />
                  <span>{o.perbaikan} Tindakan Langsung</span>
                </span>
                <span className="flex items-center gap-1">
                  <FileSearch size={10} />
                  <span>{o.investigasi} Investigasi</span>
                </span>
              </span>
            ) : null,
          }))}
              ...
              <div key={item.id} className="space-y-1.5">
                <div className="flex items-center justify-between text-sm gap-2">
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="font-medium text-slate-700 truncate block text-sm">
                        {item.name}
                      </span>
                      {item.sub && (
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 mt-0.5">
              Distribusi laporan per jenis temuan
            </p>
          </div>
        </div>
      </div>
