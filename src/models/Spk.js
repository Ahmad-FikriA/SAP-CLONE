...
const Spk = sequelize.define('Spk', {
  ...
  category:       { type: DataTypes.STRING(50), allowNull: false, validate: { isIn: [['Mekanik','Listrik','Sipil','Otomasi']] } },
  status:         { type: DataTypes.STRING(50), allowNull: false, defaultValue: 'pending', validate: { isIn: [['pending','in_progress','completed','awaiting_kasie','awaiting_kadis_perawatan','awaiting_kadis','approved']] } },
